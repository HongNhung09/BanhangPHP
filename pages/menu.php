...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="width: 100%">
  <a class="navbar-brand" href="index.php">
	<img src="/BT_CUOI_KI/images/CellphoneS-Logo-PNG-2.png" style="width: 80px;" alt="">
  </a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <!-- <form class="form-inline my-2 my-lg-0" action="index.php?quanly=timkiem" method="POST">
      <input name ="tukhoa" class="form-control mr-sm-2" type="search" placeholder="Từ khóa..." aria-label="Search">
